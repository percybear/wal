// Package  exposes functionality to get free (unused) ports on your
// system.
package discovery
...
func initialize() {
	if lowPort+maxBlocks*blockSize > maxPorts {
		panic("porter: block size is too big or too many blocks requested")
	}
	...
	panic("porter: can't allocated port block")
}
